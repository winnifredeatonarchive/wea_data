...
On <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:person[ancestor::tei:figure]" priority="1000" mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:person[@role]" priority="1000" mode="M54">
   ...
   <!--PATTERN wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-45-->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:*[@facs]" priority="1000" mode="M59">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:publisher[@ref]" priority="1000" mode="M63">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:change[@who]" priority="1000" mode="M64">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:text[@next or @prev]" priority="1000" mode="M67">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
