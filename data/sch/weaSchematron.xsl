...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-desc-deprecationInfo-only-in-deprecated-constraint-rule-9</xsl:attribute>
            <xsl:attribute name="name">wea-desc-deprecationInfo-only-in-deprecated-constraint-rule-9</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-ptr-ptrAtts-constraint-report-6</xsl:attribute>
            <xsl:attribute name="name">wea-ptr-ptrAtts-constraint-report-6</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-list-gloss-list-must-have-labels-constraint-rule-12</xsl:attribute>
            <xsl:attribute name="name">wea-list-gloss-list-must-have-labels-constraint-rule-12</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-note-note.editorialOnesShouldFollowTrailingPunct-constraint-rule-15</xsl:attribute>
            <xsl:attribute name="name">wea-note-note.editorialOnesShouldFollowTrailingPunct-constraint-rule-15</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-lg-atleast1oflggapl-constraint-assert-25</xsl:attribute>
            <xsl:attribute name="name">wea-lg-atleast1oflggapl-constraint-assert-25</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-42</xsl:attribute>
            <xsl:attribute name="name">wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-42</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-documentRefsShouldBeGood-constraint-rule-51</xsl:attribute>
            <xsl:attribute name="name">wea-documentRefsShouldBeGood-constraint-rule-51</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--PATTERN wea-desc-deprecationInfo-only-in-deprecated-constraint-rule-9-->
   ...
   <!--PATTERN wea-ptr-ptrAtts-constraint-report-6-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN wea-list-gloss-list-must-have-labels-constraint-rule-12-->
   ...
   <!--PATTERN wea-note-note.editorialOnesShouldFollowTrailingPunct-constraint-rule-15-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:person/tei:note" priority="1000" mode="M24">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:person/tei:note"/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:*[@url]" priority="1000" mode="M26">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:pb[@n]" priority="1000" mode="M27">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:text[descendant::tei:pb]" priority="1000" mode="M28">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:title[@ref]" priority="1000" mode="M30">
...
relatedItem element must be empty</svrl:text>
   ...
   <!--PATTERN wea-lg-atleast1oflggapl-constraint-assert-25-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:extent" priority="1000" mode="M37">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:sourceDesc[not(tei:bibl)]" priority="1000" mode="M38">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN wea-quotation-quotationContents-constraint-report-11-->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M39">
...
On <xsl:text/>
   ...
   <xsl:template match="tei:catRef[@scheme='wdt:docType']"
	  ...
	  <!--RULE -->
   <xsl:template match="tei:catRef[@scheme='wdt:genre']" priority="1001" mode="M41">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tei:catRef[@scheme='wdt:genre']"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="matches(@target,'^((wdt:genreShortStory)|(wdt:genreNF)|(wdt:genreNFAuto)|(wdt:genreNFDedication)|(wdt:genreNFInterview)|(wdt:genreNFIntroduction)|(wdt:genreNFEthnography)|(wdt:genreFilm)|(wdt:genreFilmScenario)|(wdt:genreFilmTreatment)|(wdt:genreFilmScreenplay)|(wdt:genrePoem)|(wdt:genreNovel)|(wdt:genreNovelSerial))$')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(@target,'^((wdt:genreShortStory)|(wdt:genreNF)|(wdt:genreNFAuto)|(wdt:genreNFDedication)|(wdt:genreNFInterview)|(wdt:genreNFIntroduction)|(wdt:genreNFEthnography)|(wdt:genreFilm)|(wdt:genreFilmScenario)|(wdt:genreFilmTreatment)|(wdt:genreFilmScreenplay)|(wdt:genrePoem)|(wdt:genreNovel)|(wdt:genreNovelSerial))$')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:revisionDesc[@status]" priority="1000" mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:figure" priority="1000" mode="M44">
   ...
   <!--PATTERN wea-msIdentifier-msId_minimal-constraint-report-14-->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M49">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:person[ancestor::tei:figure]" priority="1000" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:person[@role]" priority="1000" mode="M51">
   ...
   <!--PATTERN wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-42-->


	  <!--RULE -->
   <xsl:template match="tei:*[@facs]" priority="1000" mode="M56">
   ...
   <xsl:template match="tei:name[@ref] | tei:change[@who] | tei:rs[@ref]"
      ...
      <xsl:variable name="ids"
                    select="for $n in tokenize($att,'\s+') return substring-after($n,'pers:')"/>
      <xsl:variable name="errors"
                    select="for $i in $ids return if ($peopleIds[.=$i]) then () else $i"/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:publisher[@ref]" priority="1000" mode="M61">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:publisher[@ref]" priority="1000" mode="M62">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:publisher[@ref]"/>
      <xsl:variable name="ids"
                    select="for $n in tokenize(@ref,'\s+') return substring-after($n,'org:')"/>
      <xsl:variable name="errors"
                    select="for $i in $ids return if ($orgIds[.=$i]) then () else $i"/>
   ...
   <!--PATTERN wea-documentRefsShouldBeGood-constraint-rule-51-->


	  <!--RULE -->
   <xsl:template match="tei:*[some $a in @* satisfies (matches($a,'(^|\s+)doc:'))]"
                 priority="1000"
                 mode="M66">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count($errors) = 0">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                           ERROR: Document reference(s) <xsl:text/>
                  <xsl:value-of select="string-join($errors,', ')"/>
                  <xsl:text/> not found.
                        </svrl:text>
            </svrl:failed-assert>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:name" priority="1000" mode="M68">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:body | tei:div | tei:lg" priority="1000" mode="M73">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
