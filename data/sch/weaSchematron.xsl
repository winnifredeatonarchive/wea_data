   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-link-linkTargets3-constraint-assert-41</xsl:attribute>
            <xsl:attribute name="name">wea-link-linkTargets3-constraint-assert-41</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-relation-reforkeyorname-constraint-assert-46</xsl:attribute>
            <xsl:attribute name="name">wea-relation-reforkeyorname-constraint-assert-46</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-48</xsl:attribute>
            <xsl:attribute name="name">wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-48</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:relatedItem[@target]" priority="1000" mode="M38">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tei:relatedItem[@target]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:relatedItem" priority="1000" mode="M39">
...
relatedItem element must be empty</svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="tei:l" priority="1000" mode="M40">
   ...
   <!--RULE -->
   <xsl:template match="tei:lg" priority="1000" mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:lg"/>
      <!--REPORT -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:extent" priority="1000" mode="M43">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:sourceDesc[not(tei:bibl)]" priority="1000" mode="M44">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M45">
...
On <xsl:text/>
   ...
   <!--RULE -->
   <xsl:template match="tei:catRef[@scheme='wdt:genre']" priority="1001" mode="M47">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:revisionDesc[@status]" priority="1000" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:figure" priority="1000" mode="M50">
   ...
   <!--PATTERN wea-link-linkTargets3-constraint-assert-41-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M53">
   ...
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M54">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:person[ancestor::tei:figure]" priority="1000" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:person[@role]" priority="1000" mode="M58">
   ...
   <!--PATTERN wea-relation-reforkeyorname-constraint-assert-46-->
   <!--RULE -->
   ...
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M61">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:relation"/>
      <!--REPORT -->
   ...
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M62">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:relation"/>
      <!--REPORT -->
   ...
   <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M64">
   ...
   <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M65">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:div"/>
      <!--REPORT -->
   ...
   <!--PATTERN wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-48-->
   <!--RULE -->
   <xsl:template match="tei:*[@facs]" priority="1000" mode="M66">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:linkGrp | tei:link" priority="1001" mode="M70">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M70">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:link"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:publisher[@ref]" priority="1000" mode="M71">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:change[@who]" priority="1000" mode="M72">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:text[@next or @prev]" priority="1000" mode="M75">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:name" priority="1000" mode="M77">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:body | tei:div | tei:lg" priority="1000" mode="M82">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
