   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-subst-substContents1-constraint-assert-48</xsl:attribute>
            <xsl:attribute name="name">wea-subst-substContents1-constraint-assert-48</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
On <xsl:text/>
   ...
   <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M61">
   ...
   <!--RULE -->
   <xsl:template match="tei:*[@facs]" priority="1000" mode="M63">
   ...
   <!--PATTERN wea-subst-substContents1-constraint-assert-48-->
   <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M64">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:linkGrp | tei:link" priority="1001" mode="M68">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M68">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:link"/>
      <!--ASSERT -->
      <xsl:choose>
