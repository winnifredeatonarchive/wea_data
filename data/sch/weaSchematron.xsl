...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.cmc-generatedBy-CMC_generatedBy_within_post-constraint-rule-1</xsl:attribute>
            <xsl:attribute name="name">wea-att.cmc-generatedBy-CMC_generatedBy_within_post-constraint-rule-1</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.datable.w3c-att-datable-w3c-when-constraint-rule-2</xsl:attribute>
            <xsl:attribute name="name">wea-att.datable.w3c-att-datable-w3c-when-constraint-rule-2</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.datable.w3c-att-datable-w3c-from-constraint-rule-3</xsl:attribute>
            <xsl:attribute name="name">wea-att.datable.w3c-att-datable-w3c-from-constraint-rule-3</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.datable.w3c-att-datable-w3c-to-constraint-rule-4</xsl:attribute>
            <xsl:attribute name="name">wea-att.datable.w3c-att-datable-w3c-to-constraint-rule-4</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.global.source-source-only_1_ODD_source-constraint-rule-5</xsl:attribute>
            <xsl:attribute name="name">wea-att.global.source-source-only_1_ODD_source-constraint-rule-5</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.typed-subtypeTyped-constraint-rule-6</xsl:attribute>
            <xsl:attribute name="name">wea-att.typed-subtypeTyped-constraint-rule-6</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.pointing-targetLang-constraint-rule-7</xsl:attribute>
            <xsl:attribute name="name">wea-att.pointing-targetLang-constraint-rule-7</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.styleDef-schemeVersion-schemeVersionRequiresScheme-constraint-rule-8</xsl:attribute>
            <xsl:attribute name="name">wea-att.styleDef-schemeVersion-schemeVersionRequiresScheme-constraint-rule-8</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.calendarSystem-calendar-calendar_attr_on_empty_element-constraint-rule-9</xsl:attribute>
            <xsl:attribute name="name">wea-att.calendarSystem-calendar-calendar_attr_on_empty_element-constraint-rule-9</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-p-abstractModel-structure-p-in-ab-or-p-constraint-rule-10</xsl:attribute>
            <xsl:attribute name="name">wea-p-abstractModel-structure-p-in-ab-or-p-constraint-rule-10</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-p-abstractModel-structure-p-in-l-or-lg-constraint-rule-11</xsl:attribute>
            <xsl:attribute name="name">wea-p-abstractModel-structure-p-in-l-or-lg-constraint-rule-11</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-desc-deprecationInfo-only-in-deprecated-constraint-rule-14</xsl:attribute>
            <xsl:attribute name="name">wea-desc-deprecationInfo-only-in-deprecated-constraint-rule-14</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-name-calendar-check-name-constraint-rule-15</xsl:attribute>
            <xsl:attribute name="name">wea-name-calendar-check-name-constraint-rule-15</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-name-calendar-calendar-check-name-constraint-rule-16</xsl:attribute>
            <xsl:attribute name="name">wea-name-calendar-calendar-check-name-constraint-rule-16</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-ptr-ptrAtts-constraint-rule-19</xsl:attribute>
            <xsl:attribute name="name">wea-ptr-ptrAtts-constraint-rule-19</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-ref-refAtts-constraint-rule-20</xsl:attribute>
            <xsl:attribute name="name">wea-ref-refAtts-constraint-rule-20</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-list-gloss-list-must-have-labels-constraint-rule-21</xsl:attribute>
            <xsl:attribute name="name">wea-list-gloss-list-must-have-labels-constraint-rule-21</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-note-note.editorialOnesShouldFollowTrailingPunct-constraint-rule-24</xsl:attribute>
            <xsl:attribute name="name">wea-note-note.editorialOnesShouldFollowTrailingPunct-constraint-rule-24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-author-calendar-check-author-constraint-rule-34</xsl:attribute>
            <xsl:attribute name="name">wea-author-calendar-check-author-constraint-rule-34</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-author-calendar-calendar-check-author-constraint-rule-35</xsl:attribute>
            <xsl:attribute name="name">wea-author-calendar-calendar-check-author-constraint-rule-35</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-editor-calendar-calendar-check-editor-constraint-rule-36</xsl:attribute>
            <xsl:attribute name="name">wea-editor-calendar-calendar-check-editor-constraint-rule-36</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-resp-calendar-calendar-check-resp-constraint-rule-37</xsl:attribute>
            <xsl:attribute name="name">wea-resp-calendar-calendar-check-resp-constraint-rule-37</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-title-calendar-check-title-constraint-rule-39</xsl:attribute>
            <xsl:attribute name="name">wea-title-calendar-check-title-constraint-rule-39</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-title-calendar-calendar-check-title-constraint-rule-40</xsl:attribute>
            <xsl:attribute name="name">wea-title-calendar-calendar-check-title-constraint-rule-40</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-l-abstractModel-structure-l-in-l-constraint-rule-46</xsl:attribute>
            <xsl:attribute name="name">wea-l-abstractModel-structure-l-in-l-constraint-rule-46</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-lg-atleast1oflggapl-constraint-rule-47</xsl:attribute>
            <xsl:attribute name="name">wea-lg-atleast1oflggapl-constraint-rule-47</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-lg-abstractModel-structure-lg-in-l-constraint-rule-48</xsl:attribute>
            <xsl:attribute name="name">wea-lg-abstractModel-structure-lg-in-l-constraint-rule-48</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-idno-calendar-calendar-check-idno-constraint-rule-50</xsl:attribute>
            <xsl:attribute name="name">wea-idno-calendar-calendar-check-idno-constraint-rule-50</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-licence-calendar-calendar-check-licence-constraint-rule-51</xsl:attribute>
            <xsl:attribute name="name">wea-licence-calendar-calendar-check-licence-constraint-rule-51</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-quotation-quotationContents-constraint-rule-53</xsl:attribute>
            <xsl:attribute name="name">wea-quotation-quotationContents-constraint-rule-53</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-change-calendar-calendar-check-change-constraint-rule-61</xsl:attribute>
            <xsl:attribute name="name">wea-change-calendar-calendar-check-change-constraint-rule-61</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-link-linkTargets3-constraint-rule-65</xsl:attribute>
            <xsl:attribute name="name">wea-link-linkTargets3-constraint-rule-65</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-ab-abstractModel-structure-ab-in-l-or-lg-constraint-rule-66</xsl:attribute>
            <xsl:attribute name="name">wea-ab-abstractModel-structure-ab-in-l-or-lg-constraint-rule-66</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-msDesc-one_ms_singleton_max-constraint-rule-67</xsl:attribute>
            <xsl:attribute name="name">wea-msDesc-one_ms_singleton_max-constraint-rule-67</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-msIdentifier-msId_minimal-constraint-rule-68</xsl:attribute>
            <xsl:attribute name="name">wea-msIdentifier-msId_minimal-constraint-rule-68</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-orgName-calendar-calendar-check-orgName-constraint-rule-69</xsl:attribute>
            <xsl:attribute name="name">wea-orgName-calendar-calendar-check-orgName-constraint-rule-69</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-persName-calendar-check-persName-constraint-rule-70</xsl:attribute>
            <xsl:attribute name="name">wea-persName-calendar-check-persName-constraint-rule-70</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-persName-calendar-calendar-check-persName-constraint-rule-71</xsl:attribute>
            <xsl:attribute name="name">wea-persName-calendar-calendar-check-persName-constraint-rule-71</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-placeName-calendar-calendar-check-placeName-constraint-rule-72</xsl:attribute>
            <xsl:attribute name="name">wea-placeName-calendar-calendar-check-placeName-constraint-rule-72</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-birth-calendar-calendar-check-birth-constraint-rule-73</xsl:attribute>
            <xsl:attribute name="name">wea-birth-calendar-calendar-check-birth-constraint-rule-73</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-death-calendar-calendar-check-death-constraint-rule-74</xsl:attribute>
            <xsl:attribute name="name">wea-death-calendar-calendar-check-death-constraint-rule-74</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-event-calendar-calendar-check-event-constraint-rule-75</xsl:attribute>
            <xsl:attribute name="name">wea-event-calendar-calendar-check-event-constraint-rule-75</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-location-calendar-calendar-check-location-constraint-rule-76</xsl:attribute>
            <xsl:attribute name="name">wea-location-calendar-calendar-check-location-constraint-rule-76</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-nationality-calendar-calendar-check-nationality-constraint-rule-77</xsl:attribute>
            <xsl:attribute name="name">wea-nationality-calendar-calendar-check-nationality-constraint-rule-77</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-occupation-calendar-calendar-check-occupation-constraint-rule-78</xsl:attribute>
            <xsl:attribute name="name">wea-occupation-calendar-calendar-check-occupation-constraint-rule-78</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-relation-ref-or-key-or-name-constraint-rule-83</xsl:attribute>
            <xsl:attribute name="name">wea-relation-ref-or-key-or-name-constraint-rule-83</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-relation-active-mutual-constraint-rule-84</xsl:attribute>
            <xsl:attribute name="name">wea-relation-active-mutual-constraint-rule-84</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-relation-active-passive-constraint-rule-85</xsl:attribute>
            <xsl:attribute name="name">wea-relation-active-passive-constraint-rule-85</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-relation-calendar-calendar-check-relation-constraint-rule-86</xsl:attribute>
            <xsl:attribute name="name">wea-relation-calendar-calendar-check-relation-constraint-rule-86</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-div-abstractModel-structure-div-in-l-or-lg-constraint-rule-88</xsl:attribute>
            <xsl:attribute name="name">wea-div-abstractModel-structure-div-in-l-or-lg-constraint-rule-88</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-div-abstractModel-structure-div-in-ab-or-p-constraint-rule-89</xsl:attribute>
            <xsl:attribute name="name">wea-div-abstractModel-structure-div-in-ab-or-p-constraint-rule-89</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-90</xsl:attribute>
            <xsl:attribute name="name">wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-90</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-subst-substContents1-constraint-rule-91</xsl:attribute>
            <xsl:attribute name="name">wea-subst-substContents1-constraint-rule-91</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN wea-att.cmc-generatedBy-CMC_generatedBy_within_post-constraint-rule-1-->
   <!--RULE -->
   ...
   <!--PATTERN wea-att.datable.w3c-att-datable-w3c-when-constraint-rule-2-->
   <!--RULE -->
   ...
   <!--PATTERN wea-att.datable.w3c-att-datable-w3c-from-constraint-rule-3-->
   <!--RULE -->
   ...
   <!--PATTERN wea-att.datable.w3c-att-datable-w3c-to-constraint-rule-4-->
   <!--RULE -->
   ...
   <!--PATTERN wea-att.global.source-source-only_1_ODD_source-constraint-rule-5-->
   <!--RULE -->
   ...
   <!--PATTERN wea-att.typed-subtypeTyped-constraint-rule-6-->
   <!--RULE -->
   ...
   <!--PATTERN wea-att.pointing-targetLang-constraint-rule-7-->
   <!--RULE -->
   ...
   <!--PATTERN wea-att.styleDef-schemeVersion-schemeVersionRequiresScheme-constraint-rule-8-->
   <!--RULE -->
   ...
   <!--PATTERN wea-att.calendarSystem-calendar-calendar_attr_on_empty_element-constraint-rule-9-->
   <!--RULE -->
   ...
   <!--PATTERN wea-p-abstractModel-structure-p-in-ab-or-p-constraint-rule-10-->
   <!--RULE -->
   ...
   <!--PATTERN wea-p-abstractModel-structure-p-in-l-or-lg-constraint-rule-11-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:foreign" priority="1000" mode="M17">
   ...
   <!--PATTERN wea-desc-deprecationInfo-only-in-deprecated-constraint-rule-14-->
   <!--RULE -->
   ...
   <!--PATTERN wea-name-calendar-check-name-constraint-rule-15-->
   <!--RULE -->
   ...
   <!--PATTERN wea-name-calendar-calendar-check-name-constraint-rule-16-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:ptr[@type='readMore']" priority="1000" mode="M22">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN wea-ptr-ptrAtts-constraint-rule-19-->
   <!--RULE -->
   ...
   <!--PATTERN wea-ref-refAtts-constraint-rule-20-->
   <!--RULE -->
   ...
   <!--PATTERN wea-list-gloss-list-must-have-labels-constraint-rule-21-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:note[@type='parenthetical']" priority="1000" mode="M27">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:note[ancestor::tei:q]" priority="1000" mode="M28">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN wea-note-note.editorialOnesShouldFollowTrailingPunct-constraint-rule-24-->
   <!--RULE -->
   <xsl:template match="tei:note[@type='editorial']" priority="1000" mode="M29">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:*[@url]" priority="1000" mode="M33">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:pb[@n]" priority="1000" mode="M34">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:pb[@n][not($isFilm)]" priority="1000" mode="M35">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:text[descendant::tei:pb]" priority="1000" mode="M36">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:pb[not($isFilm)]" priority="1000" mode="M37">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:lb" priority="1000" mode="M38">
   ...
   <!--PATTERN wea-author-calendar-check-author-constraint-rule-34-->
   <!--RULE -->
   ...
   <!--PATTERN wea-author-calendar-calendar-check-author-constraint-rule-35-->
   <!--RULE -->
   ...
   <!--PATTERN wea-editor-calendar-calendar-check-editor-constraint-rule-36-->
   <!--RULE -->
   ...
   <!--PATTERN wea-resp-calendar-calendar-check-resp-constraint-rule-37-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:title[@ref]" priority="1000" mode="M43">
   ...
   <!--PATTERN wea-title-calendar-check-title-constraint-rule-39-->
   <!--RULE -->
   ...
   <!--PATTERN wea-title-calendar-calendar-check-title-constraint-rule-40-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:bibl[@type]" priority="1000" mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:bibl[@type]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="../self::tei:surrogates"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="../self::tei:surrogates">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:surrogates/tei:bibl" priority="1000" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN wea-l-abstractModel-structure-l-in-l-constraint-rule-46-->
   <!--RULE -->
   <xsl:template match="tei:l" priority="1000" mode="M51">
   ...
   <!--PATTERN wea-lg-atleast1oflggapl-constraint-rule-47-->
   <!--RULE -->
   ...
   <!--PATTERN wea-lg-abstractModel-structure-lg-in-l-constraint-rule-48-->
   <!--RULE -->
   <xsl:template match="tei:lg" priority="1000" mode="M53">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:lg"/>
      <!--REPORT -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:extent" priority="1000" mode="M54">
   ...
   <!--PATTERN wea-idno-calendar-calendar-check-idno-constraint-rule-50-->
   <!--RULE -->
   ...
   <!--PATTERN wea-licence-calendar-calendar-check-licence-constraint-rule-51-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:sourceDesc[not(tei:bibl or tei:msDesc)]"
                 priority="1000"
                 mode="M57">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tei:sourceDesc[not(tei:bibl or tei:msDesc)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN wea-quotation-quotationContents-constraint-rule-53-->
   <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M58">
      ...
      <xsl:if test="not( @marks )  and  not( tei:p )">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
          ...
          On <xsl:text/>
               <xsl:value-of select="name(.)"/>
               <xsl:text/>, either the @marks attribute should be used, or a paragraph of description provided
        </svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M58"/>
   ...
   <!--RULE -->
   <xsl:template match="tei:catRef[@scheme='wdt:genre']" priority="1001" mode="M60">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:revisionDesc[@status]" priority="1000" mode="M61">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN wea-change-calendar-calendar-check-change-constraint-rule-61-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:figure" priority="1000" mode="M64">
   ...
   <!--PATTERN wea-link-linkTargets3-constraint-rule-65-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M67">
   ...
   <!--PATTERN wea-ab-abstractModel-structure-ab-in-l-or-lg-constraint-rule-66-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M68">
   ...
   <!--PATTERN wea-msDesc-one_ms_singleton_max-constraint-rule-67-->
   <!--RULE -->
   ...
   <!--PATTERN wea-msIdentifier-msId_minimal-constraint-rule-68-->
   <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M70">
   ...
   <!--PATTERN wea-orgName-calendar-calendar-check-orgName-constraint-rule-69-->
   <!--RULE -->
   ...
   <!--PATTERN wea-persName-calendar-check-persName-constraint-rule-70-->
   <!--RULE -->
   ...
   <!--PATTERN wea-persName-calendar-calendar-check-persName-constraint-rule-71-->
   <!--RULE -->
   ...
   <!--PATTERN wea-placeName-calendar-calendar-check-placeName-constraint-rule-72-->
   <!--RULE -->
   ...
   <!--PATTERN wea-birth-calendar-calendar-check-birth-constraint-rule-73-->
   <!--RULE -->
   ...
   <!--PATTERN wea-death-calendar-calendar-check-death-constraint-rule-74-->
   <!--RULE -->
   ...
   <!--PATTERN wea-event-calendar-calendar-check-event-constraint-rule-75-->
   <!--RULE -->
   ...
   <!--PATTERN wea-location-calendar-calendar-check-location-constraint-rule-76-->
   <!--RULE -->
   ...
   <!--PATTERN wea-nationality-calendar-calendar-check-nationality-constraint-rule-77-->
   <!--RULE -->
   ...
   <!--PATTERN wea-occupation-calendar-calendar-check-occupation-constraint-rule-78-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:person[ancestor::tei:figure]" priority="1000" mode="M81">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:person[@role]" priority="1000" mode="M83">
   ...
   <!--PATTERN wea-relation-ref-or-key-or-name-constraint-rule-83-->
   <!--RULE -->
   ...
   <!--PATTERN wea-relation-active-mutual-constraint-rule-84-->
   <!--RULE -->
   ...
   <!--PATTERN wea-relation-active-passive-constraint-rule-85-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M87">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:relation"/>
      <!--REPORT -->
   ...
   <!--PATTERN wea-relation-calendar-calendar-check-relation-constraint-rule-86-->
   <!--RULE -->
   ...
   <!--PATTERN wea-div-abstractModel-structure-div-in-l-or-lg-constraint-rule-88-->
   <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M90">
   ...
   <!--PATTERN wea-div-abstractModel-structure-div-in-ab-or-p-constraint-rule-89-->
   <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M91">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:div"/>
      <!--REPORT -->
   ...
   <!--PATTERN wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-90-->
   <!--RULE -->
   <xsl:template match="tei:*[@facs]" priority="1000" mode="M92">
   ...
   <!--PATTERN wea-subst-substContents1-constraint-rule-91-->
   <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M93">
   ...
   <xsl:template match="/tei:TEI[not(ancestor::tei:teiCorpus)] | /tei:teiCorpus"
      ...
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="@xml:id and matches($docUri,concat('[/\\]',$docId,'.[\w_]+$'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@xml:id and matches($docUri,concat('[/\\]',$docId,'.[\w_]+$'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:name[starts-with(@ref,'pers:')]"
                 priority="1000"
                 mode="M97">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tei:name[starts-with(@ref,'pers:')]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="substring-after(@ref,'pers:') = $peopleIds"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="substring-after(@ref,'pers:') = $peopleIds">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>ERROR: Person with xml:id <xsl:text/>
   ...
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M98">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:link"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:msDesc/tei:msContents/tei:msItem"
                 priority="1002"
                 mode="M99">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tei:msDesc/tei:msContents/tei:msItem"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="count(tei:bibl) = 1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(tei:bibl) = 1">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="tei:msDesc/tei:msContents/tei:msItem/tei:bibl"
                 priority="1001"
                 mode="M99">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tei:msDesc/tei:msContents/tei:msItem/tei:bibl"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="matches(string-join(descendant::text()),'\S')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="matches(string-join(descendant::text()),'\S')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
   ...
   <xsl:template match="tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:title"
                 ...
                 mode="M99">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tei:teiHeader/tei:fileDesc/tei:titleStmt/tei:title"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="matches(string-join(descendant::text()),'\S')"/>
         <xsl:otherwise>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:publisher[@ref]" priority="1000" mode="M100">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:change[@who]" priority="1000" mode="M101">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:text[@next or @prev]" priority="1000" mode="M104">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:name" priority="1000" mode="M106">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:body | tei:div | tei:lg" priority="1000" mode="M111">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
