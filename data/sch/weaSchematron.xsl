   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-lg-atleast1oflggapl-constraint-assert-30</xsl:attribute>
            <xsl:attribute name="name">wea-lg-atleast1oflggapl-constraint-assert-30</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-relation-reforkeyorname-constraint-assert-45</xsl:attribute>
            <xsl:attribute name="name">wea-relation-reforkeyorname-constraint-assert-45</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:note[@type='authorial']" priority="1000" mode="M23">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:text[descendant::tei:pb]" priority="1000" mode="M33">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:pb" priority="1000" mode="M34">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:lb" priority="1000" mode="M35">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:title[@ref]" priority="1000" mode="M36">
   ...
   <!--PATTERN wea-relatedItem-targetorcontent1-constraint-report-9-->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:relatedItem" priority="1000" mode="M40">
...
relatedItem element must be empty</svrl:text>
   ...
   <!--PATTERN wea-lg-atleast1oflggapl-constraint-assert-30-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:extent" priority="1000" mode="M44">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:sourceDesc[not(tei:bibl)]" priority="1000" mode="M45">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN wea-quotation-quotationContents-constraint-report-12-->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M46">
...
On <xsl:text/>
   ...
   <xsl:template match="tei:catRef[@scheme='wdt:docType']"
	  ...
	  <!--RULE -->
   <xsl:template match="tei:catRef[@scheme='wdt:genre']" priority="1001" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:revisionDesc[@status]" priority="1000" mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:figure" priority="1000" mode="M51">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:person[@role]" priority="1000" mode="M57">
   ...
   <!--PATTERN wea-relation-reforkeyorname-constraint-assert-45-->
   ...
   <!--PATTERN wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-48-->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:*[@facs]" priority="1000" mode="M65">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:publisher[@ref]" priority="1000" mode="M69">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:change[@who]" priority="1000" mode="M70">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:text[@next or @prev]" priority="1000" mode="M73">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:name" priority="1000" mode="M75">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:body | tei:div | tei:lg" priority="1000" mode="M80">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
