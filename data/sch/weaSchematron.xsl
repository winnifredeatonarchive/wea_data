   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-link-linkTargets3-constraint-assert-42</xsl:attribute>
            <xsl:attribute name="name">wea-link-linkTargets3-constraint-assert-42</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-49</xsl:attribute>
            <xsl:attribute name="name">wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-49</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">wea-subst-substContents1-constraint-assert-49</xsl:attribute>
            <xsl:attribute name="name">wea-subst-substContents1-constraint-assert-49</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:pb[@n][not($isFilm)]" priority="1000" mode="M31">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:pb[not($isFilm)]" priority="1000" mode="M33">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:lb" priority="1000" mode="M34">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:title[@ref]" priority="1000" mode="M35">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:relatedItem[@target]" priority="1000" mode="M39">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
On <xsl:text/>
   ...
   <!--PATTERN wea-link-linkTargets3-constraint-assert-42-->
   <!--RULE -->
   ...
   <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M56">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:person[ancestor::tei:figure]" priority="1000" mode="M57">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:person[@role]" priority="1000" mode="M59">
   ...
   <!--PATTERN wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-49-->
   <!--RULE -->
   ...
   <!--PATTERN wea-subst-substContents1-constraint-assert-49-->
   <!--RULE -->
