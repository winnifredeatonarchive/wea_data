...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:relatedItem[@target]" priority="1000" mode="M37">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
On <xsl:text/>
   ...
   <!--RULE -->
   <xsl:template match="tei:*[@facs]" priority="1000" mode="M62">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:linkGrp | tei:link" priority="1001" mode="M66">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:publisher[@ref]" priority="1000" mode="M67">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:change[@who]" priority="1000" mode="M68">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:text[@next or @prev]" priority="1000" mode="M71">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:name" priority="1000" mode="M73">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:body | tei:div | tei:lg" priority="1000" mode="M78">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
