...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:*[@when]">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:*[@from]">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:*[@to]">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:*[@calendar]">
...
belongs, but this <sch:name/> element has no textual content.</sch:assert>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:*[@subtype]">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:*[@spanTo]">
...
The element indicated by @spanTo (<sch:value-of select="@spanTo"/>) must follow the current element <sch:name/>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:*[@schemeVersion]">
...
attributes @target and @cRef may be supplied on <name/>.</report>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:list[@type='gloss']">
...
relatedItem element must be empty</sch:report>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <rule context="tei:relatedItem">
               <sch:assert xmlns="http://www.tei-c.org/ns/1.0" test="@target or child::*">A relatedItem element should have either a 'target' attribute
...
remarkable at this point.</assert>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <rule context="tei:rdgGrp">
               <sch:assert xmlns="http://www.tei-c.org/ns/1.0" test="count(tei:lem) &lt; 2">Only one &lt;lem&gt; element may appear within a &lt;rdgGrp&gt;</sch:assert>
            </rule>
         </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:variantEncoding">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:path[@points]">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <rule context="tei:addSpan">
               <sch:assert xmlns="http://www.tei-c.org/ns/1.0" test="@spanTo">The @spanTo attribute of <sch:name/> is required.</sch:assert>
            </rule>
         </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <rule context="tei:addSpan">
               <sch:assert xmlns="http://www.tei-c.org/ns/1.0" test="@spanTo">L'attribut spanTo est requis.</sch:assert>
            </rule>
         </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            xmlns:xlink="http://www.w3.org/1999/xlink"
...
should correspond to an existing module, via a moduleSpec or
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:*[@validUntil]">
...
Child elements of <name/> are only allowed when an external module is being loaded
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <rule context="tei:content">
               <sch:assert xmlns="http://www.tei-c.org/ns/1.0" test="*">The use of the &lt;content&gt; element
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <rule context="tei:sequence">
               <sch:assert xmlns="http://www.tei-c.org/ns/1.0" test="count(*)&gt;1">The sequence element must have at least two child elements</sch:assert>
            </rule>
         </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <rule context="tei:alternate">
               <sch:assert xmlns="http://www.tei-c.org/ns/1.0" test="count(*)&gt;1">The alternate element must have at least two child elements</sch:assert>
            </rule>
         </pattern>
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            xmlns:xlink="http://www.w3.org/1999/xlink"
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:attDef[@usage eq 'req']">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            <sch:rule xmlns="http://www.tei-c.org/ns/1.0" context="tei:dataRef[tei:dataFacet]">
