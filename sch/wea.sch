...
relatedItem element must be empty</sch:report>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            xmlns:tei="http://www.tei-c.org/ns/1.0"
            xmlns:teix="http://www.tei-c.org/ns/Examples"
            id="wea-relatedItem-targetorcontent1-constraint-assert-22">
            <rule context="tei:relatedItem">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            xmlns:tei="http://www.tei-c.org/ns/1.0"
            xmlns:teix="http://www.tei-c.org/ns/Examples"
            id="wea-lg-atleast1oflggapl-constraint-assert-23">
            <rule context="tei:lg">
               <sch:assert xmlns:xi="http://www.w3.org/2001/XInclude"
                     xmlns:svg="http://www.w3.org/2000/svg"
                     xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
...
On <name/>, either the @marks attribute should be used, or a paragraph of description provided</report>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
            ...
            xmlns:tei="http://www.tei-c.org/ns/1.0"
            xmlns:teix="http://www.tei-c.org/ns/Examples"
            id="wea-att.global.facs-facs.mustStartWithFacs-constraint-rule-39">
      <sch:rule xmlns:xi="http://www.w3.org/2001/XInclude"
                xmlns:svg="http://www.w3.org/2000/svg"
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:math="http://www.w3.org/1998/Math/MathML"
   ...
   <sch:pattern xmlns:xi="http://www.w3.org/2001/XInclude"
                ...
                xmlns:tei="http://www.tei-c.org/ns/1.0"
                xmlns:teix="http://www.tei-c.org/ns/Examples">
                        <sch:rule context="tei:org[@xml:id]">
                         
                           <sch:assert test="starts-with(@xml:id,'org_')">
   ...
   <sch:pattern xmlns:xi="http://www.w3.org/2001/XInclude"
                ...
                xmlns:teix="http://www.tei-c.org/ns/Examples">
                        <sch:rule context="tei:bibl[@xml:id]">
                           ...
                           <sch:assert test="starts-with(@xml:id,'bibl_')">
